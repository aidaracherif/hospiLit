      ...
      <!-- Patient Stats -->
       ...
       <div class="row mb-4">
        <div class="col-md-3 mb-3">
          <div class="card">
            <div class="card-body text-center">
              <div class="display-4">{{ $patientsHospitalises }}</div>
        ...
        <div class="col-md-3 mb-3">
          <div class="card">
            <div class="card-body text-center">
              <div class="display-4">{{ $admissionsToday }}</div>
        ...
        <div class="col-md-3 mb-3">
          <div class="card">
            <div class="card-body text-center">
              <div class="display-4">{{ $sortiesToday }}</div>
        ...
        <div class="col-md-3 mb-3">
          <div class="card">
            <div class="card-body text-center">
              <div class="display-4">{{ $dureeMoyenne }}j</div>
...
$('#serviceId_add').on('change', function() {
        ...
        if (serviceId) {
            $.ajax({
                ...
                success: function(data) {
                    $('#litId_add').empty();
                    if(data.length > 0){
                        $('#litId_add').append('<option disabled selected>Sélectionner</option>');
                        $.each(data, function(key, bed) {
                            $('#litId_add').append('<option value="' + bed.id + '">Lit ' + bed.numero + ' – ' + bed.status + '</option>');
                        });
                    } else {
                        $('#litId_add').append('<option disabled selected>Aucun lit disponible</option>');
                    }
                }
            });
        } else {
            $('#litId_add').empty().append('<option disabled selected>Sélectionner un service d’abord</option>');
        }
    });
